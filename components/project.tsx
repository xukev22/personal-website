...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[42rem] borderBlack rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] even:pl-8 hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          ...
          {externalUrl && (
            <Link
              href={externalUrl}
              target="_blank"
              className="text-blue-300 hover:scale-[1.05] hover:translate-x-2 dark:text-purple-300"
            >
              See more
            </Link>
          )}
